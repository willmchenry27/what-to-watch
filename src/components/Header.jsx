const tabs = [
  ...
  { id: 'tv', label: 'TV' },
  { id: 'last_week', label: "Last Week's Top Rated" },
]
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:block text-right">
            ...
            <p className="text-xs text-cream-300/30 mt-1">
              Sorted by IMDb + Rotten Tomatoes
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-4">
          ...
          <div className="relative w-full sm:w-64">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 min-h-[44px] sm:min-h-0 bg-white/5 border border-white/10 rounded-md text-sm text-cream-100 placeholder-cream-300/30 focus:outline-none focus:border-gold-400 focus:ring-1 focus:ring-gold-400/50 transition-colors"
            />
          </div>
        </div>
      </div>
